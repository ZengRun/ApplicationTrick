...
JNIEXPORT int ompReadFile(const char *filepath, const int len, unsigned char *out);
JNIEXPORT int ompWriteFile(const char *filepath, const unsigned char *in, const int len);
